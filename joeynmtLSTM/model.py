...
class Model(nn.Module):
    ...
    def _encode_decode(
        ...
        **kwargs,
        ...
        """
        if src.shape[1] == 55:
            tokensbatch=self.src_vocab.arrays_to_sentences(src)
            labelsbatch = self.idiom_vocab.arrays_to_sentences(kwargs["idiom"])
            targetbatch = self.trg_vocab.arrays_to_sentences(trg_input)
...
def build_model(cfg: dict = None,
    ...
    idiomtagger_numclasses = len(idiom_vocab)

...
from joeynmt.decoders import RecurrentDecoder, TransformerDecoder, TransformerDecoderSagT5
...
def greedy(
    ...
    **kwargs,
    ...
    if isinstance(model.decoder, TransformerDecoder) or isinstance(model.decoder,TransformerDecoderSagT5):
...
def beam_search(
    ...
    **kwargs,
    ...
    device = encoder_output.device
    fp16: bool = kwargs.get("fp16", False)
    is_transformer = isinstance(model.decoder, TransformerDecoder) or isinstance(model.decoder, TransformerDecoderSagT5)

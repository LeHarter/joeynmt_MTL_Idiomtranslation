...
from joeynmt.idiomtagging import idiomtagging
...
def main():
    ...
    ap.add_argument("mode",
                    choices=["train", "test", "translate","idiomtagging"],
    ...
    elif args.mode == "idiomtagging":
        idiomtagging(cfg_file=args.config_path,ckpt=args.ckpt,output_path=args.output_path)
    else:
